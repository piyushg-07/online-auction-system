    ...
    <section className="text-gray-700 body-font">
      <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
        <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
          ...
          <p className="mb-8 leading-relaxed"> Welcome to the Government Road Contract Bidding System, a platform designed to ensure transparency, fairness, and efficiency in the bidding process. This system empowers government officials to post contracts, bidders to submit competitive bids, and administrators to oversee the entire process with accountability. Join us in building a transparent and trustworthy infrastructure for public projects.
          </p>
    ...
    <footer className="text-gray-700 body-font">
      ...
      <div className="bg-gray-200">
        <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
          <p className="text-gray-500 text-sm text-center sm:text-left">© 2025 Government Road Contracting System —
            <a href="https://github.com/theavnishkumar" className="text-gray-600 ml-1" target="_blank" rel="noopener noreferrer">@Module4</a>
          </p>
          <span className="sm:ml-auto sm:mt-0 mt-2 sm:w-auto w-full sm:text-left text-center text-gray-500 text-sm">Online Bidding</span>
        </div>
      </div>
    </footer>
    <a href="https://github.com/theavnishkumar/online-auction-system" className="rounded-full w-12 h-12 bg-gray-100 fixed bottom-0 right-0 flex items-center justify-center text-gray-800 mr-8 mb-8 shadow-sm border-gray-300 border" target="_blank"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
